...
3. [Open settings](https://raw.githubusercontent.com/Tetrax-10/letterboxd-custom-images/main/screenshots/script_settings.jpg) and enter your TMDB API key (login into TMDB and get it from [here](https://www.themoviedb.org/settings/api)) (used by [image chooser](#screenshots-of-image-chooser) but optional).
4. Done! 🎉
